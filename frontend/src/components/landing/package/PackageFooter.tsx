...
export const PackageFooter: React.FC<PackageFooterProps> = ({
  ...
  <>
    <Banner
      ...
      description="Profitez de mon service tout-en-un : gestion de domaine, hébergement sécurisé et support technique 24/7. Simplifiez la maintenance de votre site avec mon abonnement Premium."
    />
    <div className="mt-8 text-center">
      <p className="mx-auto text-center text-secondary font-medium text-base md:text-lg lg:text-xl  transition-text ease duration-300 mb-4 dark:text-card">
        Vous souhaitez en savoir plus ? Contactez-moi pour un devis personnalisé
        !
      </p>
