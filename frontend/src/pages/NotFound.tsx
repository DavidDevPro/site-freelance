...
import { Badge } from "@/components/ui/badge"; // Assurez-vous que ce chemin est correct
import { Separator } from "@/components/ui/separator"; // Assurez-vous que ce chemin est correct
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background px-6 py-12 text-center">
      <div className="max-w-md">
        ...
        <Link to="/"> {/* Utilisation de Link de react-router-dom pour la navigation */}
      ...
      <div className="flex justify-center w-full mt-12">
        {/* Centrer l'image SVG */}
        <svg className="w-32 h-32 text-primary opacity-30 animate-bounce" fill="currentColor" viewBox="0 0 24 24">
